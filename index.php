...
<html>
<head>
	<title>UMAHA WEBSITE DEVELOPMENT</title>
...
<body>
	...
	<div class="container" style="margin-top:20px">
		<h2>Daftar Barang Tenaga Kesehatan</h2>
		...
		<table class="table table-striped table-hover table-sm table-bordered">
			...
			<tbody>
				<?php
				$sql = mysqli_query($koneksi, "SELECT * FROM kesehatan ORDER BY id DESC") or die(mysqli_error($koneksi));
